...
--output_folder_path="/data/anomaly-marine-detection/data/l1c_copernicus_hub/images_before_keypoint_matching/"

DIRECTORY="/data/anomaly-marine-detection/src/l1c_generation/SuperGluePretrainedNetwork"
if [ ! -d "$DIRECTORY" ]; then
...
--path_keypoints_folder="/data/anomaly-marine-detection/src/l1c_generation/keypoints_pairs" \
